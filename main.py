...
def main() -> None:
    ...
    # ---------------------------------------------------------
    # Etapa 1: Gerar os dados sujos (Simulação da Entrada)
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # Etapa 2: Ler e Clean/Limpar Dados (O Motor de Limpeza)
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # Etapa 3: Banco de Dados relacional SQLite (A Persistência)
    # ---------------------------------------------------------
